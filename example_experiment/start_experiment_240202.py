...
reservoir_names = {1: "EGFP", 2: "ALFA", 6: wash_buffer}
...
for res_used in reservoir_names.keys():
    used_conn = [
        resa_conn
        for resa_conn in reservoir_a_connections
...
hamilton_config = {
    "interface": {"COM": "43", "baud": 9600},
    "system_type": "legacy",
    "valve_a": [{"address": 2, "instrument_type": "MVP", "valve_type": "8-5"}],
    "pump_a": {
        "address": 1,
        "instrument_type": "4",
        "valve_type": "8-5",
    ...
    },  # OEM/high force version internally counts in half-steps (total 6000 steps per stroke), lab version with full steps (3000 steps per stroke)
