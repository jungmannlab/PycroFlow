...
def _img_settings():
    return {'parameters': {}, 'settings': {
        'frames': 50000, 'darkframes': 50, 't_exp': 100}}
...
class SphResiBuilderTest(unittest.TestCase):
    ...
    def test_round0_disabled_single_target(self):
        reservoir_names = {
            0: 'R1-lo', 1: 'R1-hi', 2: 'R3-A1',
            7: 'Blocker', 8: 'A1-c1', 9: 'A1-c2',
            18: 'Wash Buffer 1'}
        experiment = {
            'type': 'SPH-RESI',
    ...
    def test_round0_dict_and_wash_buffer_2_two_targets(self):
        reservoir_names = {
            ...
            7: 'Blocker', 8: 'A1-c1', 9: 'A1-c2', 11: 'A2-c1',
        ...
        experiment = {
            ...
            'target-rounds': {
                'A1': {
                    'BC_imager_pre': 'R1-lo', 'frames_BC_pre': 5000,
                    'BC_imager_post': 'R1-hi', 'frames_BC_post': 15000,
                    'RESI-imager': 'R3-A1', 'RESI-frames': 50000,
                    'RESI-rounds': [
                        {'adapter': 'A1-c1', 'adapter_incubation': 0.5}],
                },
                'A2': {                          # second target -> "not last round" wash
                    'BC_imager_pre': 'R1-hi', 'frames_BC_pre': 5000,
                    'BC_imager_post': 'R1-hi', 'frames_BC_post': 15000,
                    'RESI-imager': 'R3-A2', 'RESI-frames': 50000,
                    'RESI-rounds': [
    ...
    def test_dispatch_via_create_steps_registry(self):
        ...
        reservoir_names = {
            0: 'R1-lo', 1: 'R1-hi', 2: 'R3-A1',
            7: 'Blocker', 8: 'A1-c1', 18: 'Wash Buffer 1'}
        experiment = {
            'type': 'SPH-RESI',
            'wash_buffer_1': 'Wash Buffer 1',
            'wash_buffer_2': None,
