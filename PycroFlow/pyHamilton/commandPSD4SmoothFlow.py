    ...
    def absolutePosition(self, value):
        ...
        if 0 <= value <= 192000:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow absolute position command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativePickup(self, value: int):
        ...
        if 0 <= value <= 192000:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow relative pickup command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativeDispense(self, value: int):
        ...
        if 0 <= value <= 192000:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow relative dispense command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def returnSteps(self, value: int):
        ...
        if 0 <= value <= 6400:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow return steps command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def backoffSteps(self, value: int):
        ...
        if 0 <= value <= 12800:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow backoff steps command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def setStartVelocity(self, value: int):
        ...
        if 50 <= value <= 800:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow start velocity command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def setMaximumVelocity(self, value: int):
        ...
        if 2 <= value <= 3400:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow set maximum velocity command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def stopVelocity(self, value: int):
        ...
        if 50 <= value <= 1700:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD4 smooth flow stop velocity command!"
            )
            cmd = "cmdError"
        return cmd
