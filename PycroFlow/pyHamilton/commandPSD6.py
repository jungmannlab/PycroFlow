    ...
    def absolutePosition(self, value):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 absolute position command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def absolutePositionWithReadyStatus(self, value):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 absolute position with ready status command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativePickup(self, value: int):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 relative pickup command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativePickupWithReadyStatus(self, value: int):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 relative pickup with ready status command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativeDispense(self, value: int):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 relative dispense command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def relativeDispenseWithReadyStatus(self, value: int):
        ...
        if self.checkValueInInterval(value, 6000, 48000):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 relative dispense with ready status command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def backoffSteps(self, value: int):
        ...
        if self.checkValueInInterval(value, 200, 1600):
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 backoff steps command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def standardHighResolutionSelection(self, mode: int):
        ...
        if mode == 0 or mode == 1:
            ...
            print(
                ...
                + str(mode)
                + " using PSD6 st/hg resolution selection"
            )
        else:
            cmd = "cmdError"
            print(
    ...
    def setStartVelocity(self, value: int):
        ...
        if 50 <= value <= 1000:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 start velocity command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def setMaximumVelocity(self, value: int):
        ...
        if 2 <= value <= 5800:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 set maximum velocity command!"
            )
            cmd = "cmdError"
        return cmd
    ...
    def stopVelocity(self, value: int):
        ...
        if 50 <= value <= 2700:
            ...
            print(
                "Invalid value "
                + str(value)
                + " for PSD6 stop velocity command!"
            )
            cmd = "cmdError"
        return cmd
