...
channel_exp_time = [
    100
]  # First list entry corresponds to exposure time of first channel in channel_list
...
channel_frames = [
    10
]  # First list entry corresponds to number of acquired frames of first channel in Dichro_list
...
def record_multiple_pos_channels(
    acq_dir,
    base_name,
    xy_pos_list,
    xy_pos_name_list,
        ...
        for j in range(len(Dichro_list)):
            ...
            with Acquisition(
                ...
                events = multi_d_acquisition_events(
                    num_time_points=channel_frames[j], time_interval_s=0
                )
                acq.acquire(events, keep_shutter_open=True)


record_multiple_pos_channels(
    save_dir,
    base_name,
    xy_pos_list,
    xy_pos_name_list,
